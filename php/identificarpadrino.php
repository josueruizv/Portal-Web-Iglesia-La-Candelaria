...
if(isset($_GET['cedpadrino']) and (trim($_GET['cedpadrino'])!=""))
{	
	$registros=mysqli_query($conexion,"SELECT cedula_pdr,nombre_pdr,apellido_pdr FROM padrino WHERE cedula_pdr='$_GET[cedpadrino]'");
	$reg=mysqli_fetch_array($registros);

	if(($_GET['opc']==3) or ($_GET['opc']==13))
	{
		$control=0;
		...
		{
			$registros2=mysqli_query($conexion,"SELECT cedula_mdr,nombre_mdr,apellido_mdr FROM madrina WHERE cedula_mdr='$_GET[cedpadrino]'");
			$reg2=mysqli_fetch_array($registros2);
			$num_registros2=mysqli_num_rows($registros2);
			if($num_registros2>0)
			{
				$control=2;
			}
	...
	<form name="auxiliarpadrino" id="auxiliarpadrino" method="post" action="<?php if($_GET['opc']==1) echo '../pages/bautizo.php#padrinos'; if($_GET['opc']==3) echo '../pages/confirmacion.php?fec='.$fec.'&min='.$min.'#padrinos'; if($_GET['opc']==4) echo '../pages/registroesposo.php#padrinos'; if($_GET['opc']==11) echo '../pages/editar-bautizo.php?cod='.$codigo.'#padrinos'; if($_GET['opc']==13) echo '../pages/editar-confirmacion.php?cod='.$codigo.'#padrinos'; if($_GET['opc']==14) echo '../pages/editar-matrimonio.php?cod='.$codigo.'#padrinos' ?>">
	  <?php
	  	if(($_GET['opc']!=1) and ($_GET['opc']!=11) and ($_GET['opc']!=13) and ($_GET['opc']!=14))
	  	{
	  ?>
	  ...
	  <input type="hidden" name="apemad" value="<?php echo $_GET['apellidomadre']; ?>" />
	   ...
	   ?>
		  ...
		  <input type="hidden" name="nompadri" value="<?php echo $reg['nombre_pdr']; ?>" />
		  <input type="hidden" name="apepadri" value="<?php echo $reg['apellido_pdr']; ?>" />	
	  ...
	  <?php
	   ...
	   ?>
	 	  <input type="hidden" name="cedpadri" value="<?php echo $_GET['cedpadrino']; ?>" />
		  <input type="hidden" name="nompadri" value="<?php if($control==1) echo $reg['nombre_pdr']; if($control==2) echo $reg2['nombre_mdr']; ?>" />
		  <input type="hidden" name="apepadri" value="<?php if($control==1) echo $reg['apellido_pdr']; if($control==2) echo $reg2['apellido_mdr']; ?>" /> 
		  <input type="hidden" name="sexpadri" value=<?php if($control==1) echo 'M'; if($control==2) echo 'F';  ?>>  	 	   
	  <?php
		}
...
else
{
	...
	<form name="auxiliarpadrino" id="auxiliarpadrino" method="post" action="<?php if($_GET['opc']==1) echo '../pages/bautizo.php#padrinos'; if($_GET['opc']==3) echo '../pages/confirmacion.php?fec='.$fec.'&min='.$min.'#padrinos'; if($_GET['opc']==4) echo '../pages/registroesposo.php#padrinos'; if($_GET['opc']==11) echo '../pages/editar-bautizo.php?cod='.$codigo.'#padrinos'; if($_GET['opc']==13) echo '../pages/editar-confirmacion.php?cod='.$codigo.'#padrinos'; if($_GET['opc']==14) echo '../pages/editar-matrimonio.php?cod='.$codigo.'#padrinos' ?>">
	  ...
	  <input type="hidden" name="apemad" value="<?php echo $_GET['apellidomadre']; ?>" />
	   ...
	   ?>
	 	  <input type="hidden" name="cedpadri" value="<?php echo $_GET['cedpadrino']; ?>" />
		  <input type="hidden" name="nompadri" value="" />
		  <input type="hidden" name="apepadri" value="" />	
		  <input type="hidden" name="cedmadri" value="<?php echo $_GET['cedmadrina']; ?>" />
		  <input type="hidden" name="nommadri" value="<?php echo $_GET['nombmadrina']; ?>" />
		  <input type="hidden" name="apemadri" value="<?php echo $_GET['apemadrina']; ?>" />  
		  <input type="hidden" name="observ" value="<?php echo $_GET['observaciones']; ?>" />
	  ...
	  <?php
	   ...
	   ?>
		  ...
		  <input type="hidden" name="nompadri" value="" />
		  <input type="hidden" name="apepadri" value="" />
		  <input type="hidden" name="sexpadri" value="" />
	  <?php
		}
		if(($_GET['opc']==4) or ($_GET['opc']==14))
		{
	...
	<script type="text/javascript">
	  document.auxiliarpadrino.submit();
	</script>