...
if(isset($_SESSION['usuario_nombre'])) 
{
  ...
  if(isset($_POST['fechamatri']))
  {
    $fechamatri=$_POST['fechamatri'];
  }
?>
<html lang="es">
  <head>
    ...
    <div id="contenedor-prin" class="container">
      <div class="row">
        <div id="cabecera" class="col-sm-13">
          ...
          <h3>Consulta de Matrimonio</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-1"></div>
        <div id="formulario" class="col-sm-10">
          <form name="matrimonio" class="form-horizontal" method="post" action="consultar-matrimonio.php">
            <div class="form-group">
              <br>
              <label class="col-sm-3 control-label" for="tipobusqueda">Tipo de Búsqueda:</label>
              <div class="col-sm-5">
                <select class="form-control" name="tipobusqueda" id="tipobusqueda" onchange="tipoconsultamatri(this);">
                  <option value="0" <?php if($tipobusqueda==0) echo 'selected'; ?>>Seleccione...</option>
                  <option value="1" <?php if($tipobusqueda==1) echo 'selected'; ?>>Por Cédula del Esposo o de la Esposa</option>
                  <option value="2" <?php if($tipobusqueda==2) echo 'selected'; ?>>Por Nombre y Apellido del Esposo o de la Esposa</option>
                  <option value="3" <?php if($tipobusqueda==3) echo 'selected'; ?>>Por Fecha de Matrimonio</option>
                </select>
              </div>
            </div>
            <br>
            <div class="form-group" style="<?php if($tipobusqueda!=1) echo 'display: none'?>;>" id="ConCed">
              ...
              <div class="col-sm-2">
                <input class="btn btn-primary" id="MatriCed" type="submit" name="MatriCed" value="Buscar">
              </div>
            </div>
            <span style="<?php if($tipobusqueda!=2) echo 'display: none'?>;>" id="ConNom">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input class="btn btn-primary" id="MatriNom" type="submit" name="MatriNom" value="Buscar">
                </div>
              </div>
            </span>
            <div class="form-group" style="<?php if($tipobusqueda!=3) echo 'display: none'?>;>" id="ConFecha">
              <label class="col-sm-3 control-label" for="fechamatri">Fecha de Matrimonio:</label>
              <div class="col-sm-3">
                <input class="form-control" type="date" id="fechamatri" name="fechamatri" value="<?php echo $fechamatri;?>">
              </div>
              <div class="col-sm-2">
                <input class="btn btn-primary" id="MatriFecha" type="submit" name="MatriFecha" value="Buscar">
              </div>
            </div>
          </form>
          <?php
          ...
          <div id="tablafecha">
            ...
            {
              $validarFecha=validarMatriFecha();
            }
            ?>
          </div>
        </div>
