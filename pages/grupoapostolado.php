<?php
  ...
  $registros=mysqli_query($conexion,"SELECT * FROM apostolados");
  ...
  {
    header("location: apostolados.php");
  }
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div id="contenedor-principal" class="container">
      ...
      <div class="row">
        <div class="col-sm-11 titles">
            <hgroup>
            	<?php
            		$registroapostolado=mysqli_query($conexion,"SELECT * FROM apostolados WHERE id_apostolado=$cod");
            		$regapostolado=mysqli_fetch_array($registroapostolado);
            	?>
              <h3><?php echo $regapostolado['nombre_apostolado']; ?></h3>
            </hgroup>
        </div>
      </div>
        ...
        <div class="col-sm-12">
          <div class="col-sm-8">
            <div class="col-sm-12 contenido">
              <div class="col-sm-12">
                <div class="col-sm-12">
                  	<p><?php echo nl2br($regapostolado['detalle_apostolado']); ?></p>
                </div>
              </div>
            </div>
          </div>
