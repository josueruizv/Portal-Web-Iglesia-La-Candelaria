      ...
      <div id="contenedor-prin" class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <ul>
            <?php
              $registros=mysqli_query($conexion,"SELECT DISTINCT fecha_com FROM comunion") or die(mysqli_error());
              while($reg=mysqli_fetch_array($registros))
              {
                $fcom = date('d/m/Y', strtotime(str_replace('/', '-', $reg['fecha_com'])));
            ?>
              <li>
                <h4 class="glyphicon glyphicon-file"><a href="listadocomunion.php?fecha=<?php echo $reg['fecha_com']; ?>" target="_blank"><b><?php echo $fcom; ?></b></a></h4>
              </li>
            <?php
              }
            ?>
