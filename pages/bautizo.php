<?php 
  ...
  <html lang="es">
    <head>
      ...
      function llenado(cp,c,no,ap,sex,fna,lna,regciv,cema,nomad,apmad,cedpadri,nompadri,apepadri,cedmadri,nommadri,apemadri,fecbau,min,omin,obser) 
        {
      ...
      function relleno(cm,c,no,ap,sex,fna,lna,regciv,cepa,nopad,appad,cedpadri,nompadri,apepadri,cedmadri,nommadri,apemadri,fecbau,min,omin,obser) 
        {
        ...
        function autollenar(cpadri,c,no,ap,sex,fna,lna,regciv,cepa,nopad,appad,cema,nomad,apmad,fil,cedmadri,nommadri,apemadri,fecbau,min,omin,obser) 
        {
        ...
        function autollenado(cmadri,c,no,ap,sex,fna,lna,regciv,cepa,nopad,appad,cema,nomad,apmad,fil,cedpadri,nompadri,apepadri,fecbau,min,omin,obser) 
        {
      ...
      <div id="contenedor-prin" class="container">
        ...
        <div class="row">
          ...
          <div id="formulario" class="col-sm-10">
            <form name="bautizo" class="form-horizontal" method="post" action="bautizo.php#msj">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input class="form-control" type="text" name="cedulamadrina" value="<?php echo $cedulamadrina ?>" onblur="autollenado(this.value,cedula.value,nombre.value,apellido.value,sexo.value,fechanac.value,lugarnac.value,registrocivil.value,cedulapadre.value,nombrepadre.value,apellidopadre.value,cedulamadre.value,nombremadre.value,apellidomadre.value,filiacion.value,cedulapadrino.value,nombrepadrino.value,apellidopadrino.value,fechabautizo.value,ministro.value,otroministro.value,observaciones.value)">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="submit" name="regbau" class="btn btn-primary btn-lg" value="Registrar">
                </div>
              </div>
              <div class="form-group">
                <br>
