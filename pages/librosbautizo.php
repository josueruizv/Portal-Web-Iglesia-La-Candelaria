    ...
    <body>
      <div id="contenedor-prin" class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <?php
              $registros=mysqli_query($conexion,"SELECT libro_bau FROM bautizo ORDER BY codigo_bau DESC LIMIT 1") or die(mysqli_error());
              if($reg=mysqli_fetch_array($registros))
              {
                for($i=0;$i<$reg['libro_bau'];$i++)
                {
            ?>
                <div class="col-sm-3">
                  <img src="../images/libros.png" alt="">
                  <center><h4><a href="foliosbautizo.php?libro=<?php echo $i+1; ?>"><b><?php echo $i+1; ?></b></a></h4></center>
                  <center><h4><a href="indicebautizo.php?libro=<?php echo $i+1; ?>"><b><?php echo 'Indice'; ?></b></a></h4></center>
                </div>
            <?php
                }
              }
